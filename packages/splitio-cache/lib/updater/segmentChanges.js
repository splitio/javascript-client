...
function segmentChangesUpdater(_ref2) {
  ...
  function _ref(_id) {
    if (!(_id instanceof _promise2.default)) {
      throw new TypeError('Function "segmentChangesUpdater" return value violates contract.\n\nExpected:\nPromise\n\nGot:\n' + _inspect(_id));
    }
  ...
  return _ref(_promise2.default.all([].concat((0, _toConsumableArray3.default)(segments)).map(function (segmentName) {
