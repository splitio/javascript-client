...
function mySegmentsUpdater(_ref2) {
  var authorizationKey = _ref2.authorizationKey;
  var key = _ref2.key;

  function _ref(_id) {
    if (!(_id instanceof _promise2.default)) {
      throw new TypeError('Function "mySegmentsUpdater" return value violates contract.\n\nExpected:\nPromise\n\nGot:\n' + _inspect(_id));
    }
  ...
  return _ref(mySegmentsDataSource({ authorizationKey: authorizationKey, key: key }).then(function (segmentsMutator) {
