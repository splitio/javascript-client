...
export function testSynchronizationRetries(fetchMock, assert) {
  ...
  fetchMock.getOnce(url(settings, '/splitChanges?v=1.0&since=1457552620999'), { throws: new TypeError('Network error') });
  ...
  fetchMock.getOnce(url(settings, '/splitChanges?v=1.0&since=1457552649999'), { status: 200, body: '{ "since": 1457552620999, "til' }); // invalid JSON
