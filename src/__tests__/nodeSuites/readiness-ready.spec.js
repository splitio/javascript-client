...
export default function readyPromiseAssertions(key, mock, assert) {
  ...
  }, 'Basic "time out" test. We have no retries and response takes longer than we allowed per requestTimeoutBeforeReady');
