...
tape('Hasher 128 / Impression Hasher Works', assert => {
  ...
  assert.equal(hasher.hashImpression128(imp1), hasher.hashImpression128(imp2));

  // Different feature
  imp2.feature = 'someOtherFeature';
  assert.notEqual(hasher.hashImpression128(imp1), hasher.hashImpression128(imp2));
...
tape('Hasher 128 / Impression Hasher Does Not Crash', assert => {
  ...
  imp1.keyName = null;
  assert.isNot(hasher.hashImpression128(imp1), null);
  ...
  assert.is(hasher.hashImpression128(null), null);
