 ...
 * Decode a JWT token
 */
// @TODO test availability of `decodeURIComponent` in different environments (RN, older versions of Node and Browsers)
...
export function decodeFromBase64(value) {
  ...
  // @REVIEW for other environments, such as RN or iOS webWorkers.
