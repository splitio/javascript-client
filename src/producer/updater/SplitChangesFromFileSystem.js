...
function FromFileSystemUpdaterFactory(settings: Settings, readiness: ReadinessGate, storage: SplitStorage) {

  return async function FileSystemUpdater() {
    const splits = [];
    const configs = FromFileSystemFetcher(settings);
...
module.exports = FromFileSystemUpdaterFactory;
